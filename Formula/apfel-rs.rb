class ApfelRs < Formula
  desc "Apple Intelligence & Foundation Models CLI and OpenAI-compatible server in Rust"
  ...
  conflicts_with "apfel", because: "both install `apfel` binary"
